 ...
 * @version    SVN: $Id: sfWebDebug.class.php 2019 2007-09-10 14:51:33Z alon $
 */
class sfWebDebug
{
  protected
  ...
  public function registerAssets()
  {
    ...
    $response->addJavascript('/sfAjaxWebDebugPlugin/js/ajaxWebDebug'); // added (AN)
  }
  ...
  public function getResults()
  {
    ...
    $result .= '
    <div id="sfWebDebug">
      <div id="sfWebDebugBar" class="sfWebDebug'.ucfirst($max_priority).'">' // cahnged (AN) ------->
        .'<a href="#" onclick="sfWebDebugToggleMenu(); return false;">'.image_tag('/sfAjaxWebDebugPlugin/images/sf.png', array('alt'=>'sfAjaxWebdebug plugin by Alon Noy')).'</a>
