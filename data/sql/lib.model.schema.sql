...
(
	...
	`dob` DATE,
	`quote` VARCHAR(140),
	`nb_loves` INTEGER default 0,
	`nb_hates` INTEGER default 0,
	`fb_is_on` TINYINT default 0 NOT NULL,
	`fb_uuid` VARCHAR(64),
	`fb_session_key` VARCHAR(64),
	`fb_publish_status` TINYINT(1) default 1 NOT NULL,
	`fb_publish_love` TINYINT(1) default 1 NOT NULL,
	`fb_publish_comment` TINYINT(1) default 1 NOT NULL,
	`created_at` DATETIME,
	PRIMARY KEY (`id`),
