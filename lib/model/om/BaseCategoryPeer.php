...
abstract class BaseCategoryPeer {
	...
	const ID = 'articles_categories.ID';

	
	const TITLE = 'articles_categories.TITLE';

	
	const STRIPPED_TITLE = 'articles_categories.STRIPPED_TITLE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'StrippedTitle', ),
		BasePeer::TYPE_COLNAME => array (CategoryPeer::ID, CategoryPeer::TITLE, CategoryPeer::STRIPPED_TITLE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'stripped_title', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'StrippedTitle' => 2, ),
		BasePeer::TYPE_COLNAME => array (CategoryPeer::ID => 0, CategoryPeer::TITLE => 1, CategoryPeer::STRIPPED_TITLE => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'stripped_title' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CategoryPeer::STRIPPED_TITLE);

	}

	const COUNT = 'COUNT(articles_categories.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT articles_categories.ID)';
