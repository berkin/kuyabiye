 ...
 * @version    SVN: $Id: sfWebDebugFilter.class.php 2017 2007-09-10 12:47:14Z alon $
 */
class sfWebDebugFilter extends sfFilter
{
  ...
  public function execute($filterChain)
  {
    ...
    if($this->getContext()->getRequest()->isXmlHttpRequest()) {
      $controller->getActionStack()->getLastEntry()->getActionInstance()->setFlash('_ajaxWebDebug', sfWebDebug::getInstance()->getResults());
      return;
    }
    // end (AN)
